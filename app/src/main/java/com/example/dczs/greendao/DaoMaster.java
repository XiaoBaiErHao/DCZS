...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        AddModifyMenuBeanDao.createTable(db, ifNotExists);
        OrderFormBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        AddModifyMenuBeanDao.dropTable(db, ifExists);
        OrderFormBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AddModifyMenuBeanDao.class);
        registerDaoClass(OrderFormBeanDao.class);
