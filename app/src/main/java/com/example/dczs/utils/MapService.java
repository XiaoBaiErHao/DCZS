...
public class MapService extends Service {
    public List<AddressMessageBean> addressMessageBeanList = new ArrayList<>();
...
//        locationOption.setOpenAutoNotifyMode();
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
           ...
           // String accelerated_speed=location.getsp
            ...
            LogUtil.e(TAG, "onReceiveLocation: "+errorCode );
            LogUtil.e("--------------", address + "\n"
            + location.getLatitude() + "\n" + location.getLongitude() + "\n");

            AddressMessageBean addressMessageBean = MyApplication.getAnEntitySet().getAddressMessageBean();
            ...
            addressMessageBean.setDistrict(district);
            addressMessageBean.setStreet(street);
            addressMessageBean.setAddress(address);
    ...
    private void pushDataToServe(){
        for (int i = 0; i < addressMessageBeanList.size(); i++){
            LogUtil.e(TAG, "pushDataToServe: "+addressMessageBeanList.get(i).getTime());
