...
public class OrderHistoryAdapter extends RecyclerView.Adapter{
    ...
    public OrderHistoryAdapter( Context context, List<OrderFormBean> orderFormBeans) {
        mContext = context;
        orderFormBeansList = orderFormBeans;
    }

    public void setOrderHistoryList(List<OrderFormBean> orderFormBeans){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        try{
           ...
           if (orderFormBeansList.get(position).getOrderStatus().equals("0")){
               viewholder.mBtStatus.setText("正在配菜");
           } else if (orderFormBeansList.get(position).getOrderStatus().equals("1")){
                viewholder.mBtStatus.setText("正在派送中");
            } else if (orderFormBeansList.get(position).getOrderStatus().equals("2")){
                viewholder.mBtStatus.setText("派送已完成");
            }
